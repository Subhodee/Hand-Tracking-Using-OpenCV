...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone  https://github.com/Subhodee/Hand-Tracking-Using-OpenCV.git
     ```
